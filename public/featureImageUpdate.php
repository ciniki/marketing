...
function ciniki_marketing_featureImageUpdate(&$ciniki) {
    ...
    $rc = ciniki_marketing_checkAccess($ciniki, $args['tnid'], 'ciniki.marketing.featureImageUpdate'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }
    ...
    return ciniki_core_objectUpdate($ciniki, $args['tnid'], 'ciniki.marketing.feature_image', $args['feature_image_id'], $args);
}
?>
